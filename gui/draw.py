...
from globalsa import board_colour, square_size
import globalsa
...
def draw_background(win):
    ...
    if globalsa.from_square:
        pygame.draw.rect(win, FROM_COLOUR, (globalsa.from_square[0] * square_size, globalsa.from_square[1] * square_size, square_size, square_size))

    if globalsa.to_square:
        pygame.draw.rect(win, TO_COLOUR, (globalsa.to_square[0] * square_size, globalsa.to_square[1] * square_size, square_size, square_size))
